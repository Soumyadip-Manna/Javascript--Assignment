...
viewer("child", "adult", or "senior"). Write a program which calculates the price acordingly and prints the total
...
console.log("Total price After Booking Tickets is : ",totalPrice);